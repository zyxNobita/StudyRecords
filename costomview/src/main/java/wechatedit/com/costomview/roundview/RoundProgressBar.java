...
public class RoundProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setStrokeWidth(1); //暂时写死在这里，根据自己项目调整该值大小，如果有需要也可写入attr中
        ...
        paint.setStyle(Paint.Style.FILL);
        RectF oval = new RectF(maxLayerX - radius + 11, maxLayerX - radius + 11,
                maxLayerX + radius - 11, maxLayerX + radius - 11);  //用于定义的圆弧的形状和大小的界限
